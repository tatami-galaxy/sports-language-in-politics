...
if __name__ == "__main__":
    ...
    if args.sample:
        print('sampling')
        president_comments = president_comments[:args.sample_size]
        president_ids = president_ids[:args.sample_size]

    print(len(president_comments))
    print(len(president_ids))
    ...
    for c in range(len(president_comments)):
        ...
        comment_dict[president_ids[c]] = {s:[] for s in TARGETS+SUBSTITUTES}
